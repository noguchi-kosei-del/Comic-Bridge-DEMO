...
export const WORKFLOWS: Workflow[] = [
  {
    ...
    steps: [
      ...
      { label: "テキストチェック", desc: "画像/PDFとテキストを並べて確認", nav: "textDiff", confirmOnNext: "textSave" },
      { label: "校正プロンプト", desc: "正誤チェック・提案チェック", nav: "progen", progenMode: "_check" },
      { label: "テキストエディタで修正", desc: "確定ボタンで自動保存", nav: "textEditor", confirmOnNext: "textSave" },
  ...
  },
  {
    ...
    steps: [
      ...
      { label: "ビューアーで確認・修正", desc: "フォント・サイズ・白消し・AA・カーニング・フォント帳", nav: "textDiff", confirmOnNext: "textDiffThenExtract" },
  ...
  },
  {
    ...
    steps: [
      ...
      { label: "差し替え → 差分検知ビュー", desc: "差分チェック", nav: "inspection" },
      ...
      { label: "差分検知ビュー", desc: "変換結果チェック", nav: "inspection" },
