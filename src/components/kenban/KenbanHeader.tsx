...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <div
      className={`bg-neutral-900 border-b border-white/[0.06] shadow-[0_1px_3px_rgba(0,0,0,0.3)] flex items-center px-4 gap-4 shrink-0 overflow-hidden transition-all duration-300 ease-in-out ${isFullscreen || fullscreenTransitioning ? "h-0 opacity-0 border-b-0" : "h-10 opacity-100"}`}
    >
      <button
        onClick={onReset}
